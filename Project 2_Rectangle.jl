...
function rectangular_wing(root, span, num_sec, filename)
...
"""
    rectangular_wing(root, span, num_sec, filename)
...
root = 5
num_sec = i
filename = "Rectangular_wing_section_plot.pdf"
x_points, y_points, points, chords = rectangular_wing(root, span, num_sec, filename)
