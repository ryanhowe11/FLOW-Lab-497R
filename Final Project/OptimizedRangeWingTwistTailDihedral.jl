...
using Statistics
using LinearAlgebra
include("OptimizedRangeWingTwistTailDihedralFunctions.jl")
...
x1, f1 = OptimizeTwist(N, density, xstart_vec)

xstart_vec = ones(N+6)
x2, f2 = OptimizeTwist(N, density, xstart_vec)

xstart_vec = 5*ones(N+6)
x3, f3 = OptimizeTwist(N, density, xstart_vec)

xstart_vec = [.1, .2, .3, .4, .5, .6, .7, .8, .9, 1, 2, 2, 2, 2, 2, 2]
x4, f4 = OptimizeTwist(N, density, xstart_vec)

xstart_vec = [2.1, 1.9, 1.7, 1.5, 1.3, 1.1, .9, .7, .5, .3, 2, 2, 2, 2, 2, 2]
x5, f5 = OptimizeTwist(N, density, xstart_vec)

xstart_vec = [2.1, 2.9, 1.7, 3.5, .3, 4.1, 2.9, 1.7, 3.5, 4.73, 2, 2, 2, 2, 2, 2]
x6, f6 = OptimizeTwist(N, density, xstart_vec)

xstart_vec = [.1, .2, .3, .4, .5, .6, .7, .8, .9, 1, 1, 2, 3, 4, 5, 6]
x7, f7 = OptimizeTwist(N, density, xstart_vec)

xstart_vec = [2.1, 1.9, 1.7, 1.5, 1.3, 1.1, .9, .7, .5, .3, 6, 5, 4, 3, 2, 1]
x8, f8 = OptimizeTwist(N, density, xstart_vec)

xstart_vec = [2.1, 2.9, 1.7, 3.5, .3, 4.1, 2.9, 1.7, 3.5, 4.73, 3, 2, 4, 1, 5, 2]
x9, f9 = OptimizeTwist(N, density, xstart_vec)

xstart_vec = [1.1, 3.9, .07, 4.56, .03, 4.91, 3.9, 2.1, .5, 4.73, .1, 4.8, 2.5, 6, 1, 5]
x10, f10 = OptimizeTwist(N, density, xstart_vec)