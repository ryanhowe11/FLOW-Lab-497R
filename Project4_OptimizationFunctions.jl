...
function optimizex(;chordopt)
        ...
        function wing_optimizer(g, theta)
            ...
            if Include_Airframe == 1
                ...
                D, weight, rho, Vinf, Sref, CL, chords, fs = Airframe_Drag_Calculation_Theta(chordopt, num_sec, scale_factor, Chord_Length)

            else

                D, weight, rho, Vinf, Sref, CL, chords, fs = Drag_Calculation_Theta(chordopt, num_sec, scale_factor, Chord_Length)
